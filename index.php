...
<html lang="en">
  ...
  <body>
    ...
    <div class="wrap">
      <?php
      //add dynamic header in Home page.
       include_once 'includeFrontend/header.php';
      ?>

      <?php
      include_once 'includeFrontend/slider.php';
      ?>
      ...
      <section class="site-section py-sm">
        <div class="container">
          ...
          <div class="row blog-entries">
           ...
           <?php
           include_once 'includeFrontend/sidebar.php';
           ?>
            <!-- END sidebar -->
     ...
     <?php
     include_once 'includeFrontend/footer.php';
     ?>
      <!-- END footer -->
